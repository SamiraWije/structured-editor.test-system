...
import javax.swing.*;
/**
 * @author Loïc Le Coq date 31/10/2006 This class defines the renderer for the
...
public class DecorationAngleListRenderer extends JPanel
  ...
  private final Line2D.Double tick = new Line2D.Double();
  private final Arc2D.Double arc = new Arc2D.Double();
  private final GeneralPath polygon = new GeneralPath();
