...
public class Layout {
   ...
   */
  private class ManagePerspectivesDialog extends JDialog
      implements
        ActionListener {
    ...
    protected ManagePerspectivesDialog(Application app, Layout layout) {
      super(app.getFrame());
      ...
      setModal(true);
      setTitle(geogebra.Menu.ManagePerspectives);
      buildGUI();
      pack();
    ...
    private void buildGUI() {
      ...
      removeButton = new JButton(Plain.Remove);
      removeButton.addActionListener(this);
      updateRemoveButton();
      buttonPanel.add(removeButton);

      cancelButton = new JButton(Plain.Cancel);
  ...
  private class SaveInputHandler implements InputHandler {
    ...
    protected SaveInputHandler(Layout layout) {
      this.layout = layout;
    }
  ...
  public Layout() {
    ...
    perspectives = new ArrayList<Perspective>(defaultPerspectives.length);
  }
  ...
  public void applyPerspective(Perspective perspective) {
    ...
    dockManager.applyPerspective(perspective.getSplitPaneInfo(), perspective
        .getDockPanelInfo());
   ...
   * @return
   */
  protected Perspective createPerspective(String id) {
    ...
    perspective
        .setToolbarDefinition(app.getGuiManager().getToolBarDefinition());
  ...
  public String getXml(boolean asPreference) {
    /**
     * Create a temporary perspective which is used to store the layout of the
     * document at the moment. This perspective isn't accessible through the
     * menu and will be removed as soon as the document was saved with another
     * perspective.
     */
    ...
    /**
     * Certain user elements should be just saved as preferences and not if a
     * document is saved normally as they just depend on the preferences of the
     * user.
     */
  ...
  private void initializeDefaultPerspectives() {
    ...
    dpInfo[0] = new DockPanelXml(Application.VIEW_EUCLIDIAN, true, false,
        new Rectangle(100, 100, 600, 400), "1", 500);
    dpInfo[1] = new DockPanelXml(Application.VIEW_ALGEBRA, true, false,
        new Rectangle(100, 100, 250, 400), "3", 200);
    dpInfo[2] = new DockPanelXml(Application.VIEW_SPREADSHEET, false, false,
        new Rectangle(100, 100, 600, 400), "1,1", 300);
    dpInfo[3] = new DockPanelXml(Application.VIEW_CAS, false, false,
        new Rectangle(100, 100, 600, 400), "1,3", 300);
    ...
    defaultPerspectives[0] = new Perspective("AlgebraAndGraphics", spInfo,
        dpInfo, defToolbar, false, true, true, true, false);

    // basic geometry - just the euclidian view
    dpInfo = new DockPanelXml[4];
    dpInfo[0] = new DockPanelXml(Application.VIEW_EUCLIDIAN, true, false,
        new Rectangle(100, 100, 600, 400), "1", 500);
    dpInfo[1] = new DockPanelXml(Application.VIEW_ALGEBRA, false, false,
        new Rectangle(100, 100, 250, 400), "3", 200);
    dpInfo[2] = new DockPanelXml(Application.VIEW_SPREADSHEET, false, false,
        new Rectangle(100, 100, 600, 400), "1,1", 300);
    dpInfo[3] = new DockPanelXml(Application.VIEW_CAS, false, false,
    ...
    defaultPerspectives[1] = new Perspective("BasicGeometry", spInfo, dpInfo,
        "2", false, false, false, true, false);

    // geometry - like basic geometry but with more toolbar entries
    defaultPerspectives[2] = new Perspective("Geometry", spInfo, dpInfo,
        "0 | 40 | 1", true, true, true, false, true);
    ...
    dpInfo[0] = new DockPanelXml(Application.VIEW_EUCLIDIAN, true, false,
        new Rectangle(100, 100, 600, 400), "1", 500);
    dpInfo[1] = new DockPanelXml(Application.VIEW_ALGEBRA, false, false,
        new Rectangle(100, 100, 250, 400), "3,3", 200);
    dpInfo[2] = new DockPanelXml(Application.VIEW_SPREADSHEET, true, false,
        new Rectangle(100, 100, 600, 400), "3", 300);
    dpInfo[3] = new DockPanelXml(Application.VIEW_CAS, false, false,
        new Rectangle(100, 100, 600, 400), "3,1", 300);

    defaultPerspectives[3] = new Perspective("TableAndGraphics", spInfo,
        dpInfo, "0 | 40 | 1", false, false, false, true, false);
  }
   ...
   * @param index
   */
  protected void removePerspective(int index) {
  ...
  public void showSaveDialog() {
    InputDialog inputDialog = new InputDialog(app, Plain.PerspectiveName,
        geogebra.Menu.SaveCurrentPerspective, "", false, new SaveInputHandler(
            this));
