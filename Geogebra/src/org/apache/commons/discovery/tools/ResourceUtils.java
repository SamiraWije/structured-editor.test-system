...
public class ResourceUtils {
     ...
     */
    public static String getPackageName(Class<? extends ResourceDiscoverImpl> clazz) {
     ...
     */
    public static Resource getResource(Class<? extends ResourceDiscoverImpl> spi,
                                       String resourceName,
     ...
     *            (or extend) the SPI.
     */    
    public static Properties loadProperties(Class<? extends ResourceDiscoverImpl> spi,
