    ...
    implements ResourceNameDiscover
{
    ...
    public ResourceNameIterator findResourceNames(final String serviceName) {
        ...
        return new ResourceNameIterator() {
            private int idx = 0;
            private Vector<String> classNames = null;
            ...
            private Vector<String> getNextClassNames() {
                while (files.hasNext()) {
                    Vector<String> results = readServices(files.nextResource());
     ...
     */
    private Vector<String> readServices(final Resource info) {
