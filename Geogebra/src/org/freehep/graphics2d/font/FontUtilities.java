...
public class FontUtilities {
     ...
     */
    public static Hashtable<TextAttribute, Serializable> getAttributes(Font font) {
        Hashtable<TextAttribute, Serializable> result = new Hashtable<TextAttribute, Serializable>(7, (float)0.9);
        result.put(
