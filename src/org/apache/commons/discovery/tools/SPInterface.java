...
public class SPInterface {
     ...
     * to those two.
     */        
    private final Class<? extends ResourceDiscoverImpl> spi;
     ...
     */
    public SPInterface(Class<? extends ResourceDiscoverImpl> spi, String propertyName) {
        this.spi = spi;
     ...
     *        constructor arguments.
     */
    public SPInterface(Class<? extends ResourceDiscoverImpl> spi,
                       String propertyName,
                       Class constructorParamClasses[],
                       Object constructorParams[])
    {
    ...
    public Class<? extends ResourceDiscoverImpl> getSPClass() {
        return spi;
    }
