...
public class PatternCreate extends BuiltinFunction
{
    ...
    public void evaluate(Environment aEnvironment, int aStackTop) throws Exception
    {
        ...
        LispError.checkArgument(aEnvironment, aStackTop, patternPointerTraverser.car() instanceof ConsPointer, 1);
        ...
        getTopOfStackPointer(aEnvironment, aStackTop).setCons(BuiltinObjectCons.getInstance(patternContainer));
    }
}
