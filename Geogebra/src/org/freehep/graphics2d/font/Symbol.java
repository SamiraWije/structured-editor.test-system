...
public class Symbol extends AbstractCharTable {
  private final Hashtable<Character, String> unicodeToName = new Hashtable<Character, String>();
  private final Hashtable<String, Character> nameToUnicode = new Hashtable<String, Character>();
  private final Hashtable<String, Integer> nameToEnc = new Hashtable<String, Integer>();
  ...
  public int toEncoding(String name) {
    return nameToEnc.get(name).intValue();
  }
  ...
  public char toUnicode(String name) {
    return nameToUnicode.get(name).charValue();
  }
