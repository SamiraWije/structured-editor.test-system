...
import geogebra.gui.util.foxtrot.workers.SingleWorkerThread;
...
public class Worker extends AbstractSyncWorker
{
    ...
    /**
     * Returns the WorkerThread used to run {@link geogebra.gui.util.foxtrot.Task}s subclasses in a thread
    ...
    /**
     * Sets the WorkerThread used to run {@link geogebra.gui.util.foxtrot.Task}s subclasses in a thread
     * that is not the Event Dispatch Thread.
     *
