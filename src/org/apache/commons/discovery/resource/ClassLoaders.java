...
{
    protected Vector<ClassLoader> classLoaders = new Vector<ClassLoader>();
    ...
    public ClassLoader get(int idx) {
        return classLoaders.elementAt(idx);
    }
     ...
     */    
    public static ClassLoaders getLibLoaders(Class<? extends ResourceDiscoverImpl> spi, Class<DiscoverClass> factory, boolean prune) {
     ...
     * @param prune Determines if ancestors are allowed to be loaded or not.
     */    
    public static ClassLoaders getAppLoaders(Class<? extends ResourceDiscoverImpl> spi, Class<Service> factory, boolean prune) {
        ClassLoaders loaders = new ClassLoaders();
