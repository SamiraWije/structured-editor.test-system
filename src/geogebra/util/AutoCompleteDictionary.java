...
public interface AutoCompleteDictionary {
   ...
   * 
   * @param s
   *          The string to use as the base for the lookup. How this routine is
   *          implemented determines the behaviour of the component. Typically,
   *          the closest matching string that completely contains the given
   *          string is returned.
   */
