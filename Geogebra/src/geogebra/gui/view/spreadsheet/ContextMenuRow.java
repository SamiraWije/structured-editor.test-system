...
public class ContextMenuRow extends ContextMenu
{
	...
	protected void initMenu() {
		...
		//addSeparator();
   	 	...
   	 	JMenuItem item5 = new JMenuItem(geogebra.Menu.InsertAbove);
	   	item5.setIcon(app.getEmptyIcon());
   	 	item5.addActionListener(new InsertAbove());   	 	
   	 	add(item5);
   	 	JMenuItem item6 = new JMenuItem(geogebra.Menu.InsertBelow);
	   	item6.setIcon(app.getEmptyIcon());
   	 	item6.addActionListener(new InsertBelow());   	 	
   	 	add(item6);
		addSeparator();
   	 	JMenuItem item7;
   	 	if (row1 == row2) item7 = new JMenuItem(geogebra.Menu.ClearRow);
   	 	else item7 = new JMenuItem(geogebra.Menu.ClearRows);
