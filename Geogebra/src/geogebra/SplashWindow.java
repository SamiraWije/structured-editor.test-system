 ...
 *     getClass().getResource(&quot;splash.png&quot;))).show();
 * </pre>
 * 
...
class SplashWindow extends Window {
  ...
  private static final long serialVersionUID = 6259351820446575875L;

  /**
   * Constructs and displays a SplashWindow.
   * <p>
   * This method is useful for startup splashs. Dispose the return frame to get
   ...
   */
  protected static Frame splash(Image splashImage) {
    System.out.println("splash(Image splashImage)");
    Frame f = new Frame();
    SplashWindow w = new SplashWindow(f, splashImage, false);

    System.out.println("ѕоказываем окно с загрузочной картинкой");
    w.toFront();
    w.setVisible(true);
  ...
  /**
   * Constructs a splash window and centers it on the screen. The user can click
   * on the window to dispose it.
   * 
   * @param owner
   ...
   */
  private SplashWindow(Frame owner, Image splashImage, boolean canDispose) {
    super(owner);
    ...
    System.out.println("Center the window on the screen.");
