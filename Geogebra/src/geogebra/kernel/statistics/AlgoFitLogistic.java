...
/// ============= IMPLEMENTATION =============================================================///
    ...
    private final   void getPoints(){
        ...
        java.util.TreeSet<GeoElement> sortedSet;
        sortedSet=new java.util.TreeSet<GeoElement>(GeoPoint.getComparatorX());
        for (int i=0;i<size;i++){
        ...
        java.util.Iterator<GeoElement> iter=sortedSet.iterator();
