...
public class Parser implements ParserConstants {
  ...
  static private final class LookaheadSuccess extends java.lang.Error {
     ...
     * 
     */
    private static final long serialVersionUID = 7136873187871542313L;
  }
  ...
  private ParserTokenManager token_source;
  ...
  private static void jj_la1_0() {
    jj_la1_0 = new int[]{0x0, 0x0, 0x0, 0x0, 0x40, 0x21, 0x0, 0x21, 0x61800100,
        0x21, 0x0, 0x0, 0x0, 0x0, 0x61800100, 0x0, 0x61800100, 0x0, 0x0, 0x0,
        0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1800000, 0x2000000, 0x61800100,
        0x400040, 0x0, 0x200, 0x400, 0x3ff800, 0x3ff800, 0x1800000, 0x1800000,
        0x6e000100, 0xe000000, 0x6e000100, 0x61800100, 0x80000000, 0x20000100,
        0x60000100, 0x40000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40000000,
        0x0, 0x0, 0x0,};
  }

  private static void jj_la1_1() {
    jj_la1_1 = new int[]{0x1800000, 0x1800000, 0x1800000, 0x1800000, 0x0, 0x0,
        0x1800000, 0x0, 0xf99fbe00, 0x0, 0x0, 0x0, 0x1860000, 0x1800000,
        0xf99fbe00, 0x0, 0xf99fbe00, 0x0, 0x1800000, 0x1800000, 0x0, 0x1800000,
        0x1800000, 0x0, 0x1800000, 0x1800000, 0x0, 0x0, 0xf99fbe00, 0x0,
        0x1860000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf99fbe00, 0x0, 0xf99fbe00,
        0xf99fbe00, 0x1ff, 0x0, 0xf99fbe00, 0x19be00, 0x0, 0x0, 0x0, 0x1800000,
        0x60000, 0x1800000, 0x180000, 0x183e00, 0xf8000000, 0x0, 0x0,};
  }

  /**
   * NOT USED BY NOW normalvectorform = <PARAMETRICVAR> vector = vector
   * 
   * NormalVectorForm normalvectorform(): { ExpressionNode left, right;
   * ExpressionValue temp; } { <PARAMETRICVAR> (<MULTIPLY>)? left = enterm()
   * <EQUAL> right = expressionnode() { // check if left is VectorValue and
   * right is NumberValue temp = left.evaluate(); if (!(temp instanceof
   * VectorValue)) { String [] str = { "VectorExpected", temp.toString() };
   * throw new MyParseError(app, str); }
   * 
   * temp = right.evaluate(); if (!(temp instanceof NumberValue)) { String []
   * str = { "NumberExpected", temp.toString() }; throw new MyParseError(app,
   * str); }
   * 
  ...
  /******************************************************************
   * ARTIHMETIC FOR NUMBERS AND 2D VECTORS WITH VARIABLES plus ARTIHMETIC FOR
   * POLYNOMIALS WITH VARIABLES "x" AND "y" exponents must be integers >= 0
   * divisors must be simplifyable to numbers
   ******************************************************************/

  private static void jj_la1_2() {
    jj_la1_2 = new int[]{0x0, 0x0, 0x0, 0x0, 0x4000000, 0x0, 0x0, 0x0,
        0x9ffffff, 0x0, 0x20000000, 0x8000000, 0x0, 0x0, 0x9ffffff, 0x20000000,
        0x9ffffff, 0x20000000, 0x800000, 0x0, 0x20000000, 0x0, 0x0, 0x20000000,
        0x0, 0x8000000, 0x0, 0x0, 0x9ffffff, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
        0x0, 0x9ffffff, 0x0, 0x9ffffff, 0x9ffffff, 0x0, 0x0, 0x9ffffff, 0x0,
        0x1000000, 0x20000000, 0x8000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0xffffff,
        0x0, 0x0,};
  }

  private static void jj_la1_3() {
    jj_la1_3 = new int[]{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x0, 0x0,
        0x0, 0x0, 0x0, 0x2, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
        0x0, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x0,
        0x2, 0x2, 0x0, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
        0x0, 0x2, 0x2,};
  }
  ...
  /*
   * functions of other variables than x not implemented yet | ( // e.g. f(t) =
   * t^2 var = <LABEL> ")" "=" rhs = expressionnode() { f = new Function(rhs,
   * var.image); f.setLabel(l.image.substring(0,l.image.length()-1)); return f;
   * } )
   */
   ...
   * 
   * ValidExpression functionOrCommand(): { ExpressionNode rhs; Token l = null;
   * Token var; Function f; Command c; } { LOOKAHEAD(10) ( // f(x) = Derivative[
   * 3 x^2 ] l = <FUNCTION_LABEL> <VARX> ")" "=" c = command() {
   * c.setLabel(l.image.substring(0,l.image.length()-1)); return c; } ) | ( //
   * f(x) = x^2 + 3 l = <FUNCTION_LABEL> <VARX> ")" "=" rhs = expressionnode() {
   * f = new Function(rhs); f.setLabel(l.image.substring(0,l.image.length()-1));
   * return f; } )
   * 
   * }
   */
  ...
  /**
   * for GeoGebra input field validexpression = labellist() = command() | //
   * e.g. {A,B} = Intersect[c, g] <LABEL> : parametric() | // e.g. X = (3,2) + t
   * (2,1) <LABEL> = expression() // arithmetic expression of floats, vectors
   * and vars <LABEL> : equation() // equation in x an y <LABEL>(x) = function()
   * // function in x, e.g. f(x) = 3x^3 - sqrt(x)
   */
  final public ValidExpression buildValidExpression() throws ParseException {
    ...
    if (labels.size() > 0)
      ve.addLabel(labels); // command with ouput labels
  ...
  /**
   * cmdexpression = expressionnode (may only return Function)
   */
      ...
      switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
        ...
        case 97 :
          ...
          if (en.includesPolynomial())
            if (en.isFunctionInX())
              return new ExpressionNode(kernel, new Function(en));
            else
              throw new MyError(app, "IncompleteEquation");

          // since v3.0: commands have to take care of resolving the variables
          // of
  ...
  final public Command command() throws ParseException {
    ...
    switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
      ...
      case FUNCTION_LABEL :
        ...
        c = new Command(kernel, t.image.substring(0, t.image.length() - 1),
            true);
        switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
          case NOT :
          case PLUS :
        ...
        switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
          case EQUAL_BOOLEAN :
            ...
            if (MathPiperParsing)
              ...
              ret = new ExpressionNode(kernel, ret,
                  ExpressionNode.EQUAL_BOOLEAN, f);
            break;
          case NOT_EQUAL :
          ...
          case IS_ELEMENT_OF :
            ...
            f = plusminusnode();
            ret = new ExpressionNode(kernel, ret, ExpressionNode.IS_ELEMENT_OF,
                f);
            break;
          case CONTAINS :
          ...
          case CONTAINS_STRICT :
            ...
            f = plusminusnode();
            ret = new ExpressionNode(kernel, ret,
                ExpressionNode.CONTAINS_STRICT, f);
            break;
          case LESS :
          ...
          case GREATER_EQUAL :
            ...
            f = plusminusnode();
            ret = new ExpressionNode(kernel, ret, ExpressionNode.GREATER_EQUAL,
                f);
            break;
          case PARALLEL :
          ...
          case PERPENDICULAR :
            ...
            f = plusminusnode();
            ret = new ExpressionNode(kernel, ret, ExpressionNode.PERPENDICULAR,
                f);
            break;
          default :
            jj_la1[33] = jj_gen;
  ...
  /**
   * element = <variable> | <float> | ( expression )
   */
  ...
  /**
   * factorial = <NOTterm> | <NOTterm> !
   */
  final private ExpressionValue enfactorial() throws ParseException {
    ExpressionValue en;
    en = NOTterm();
  ...
  /**
   * power = element | element ^ power
   */
  final private ExpressionValue enpower() throws ParseException {
    ExpressionValue ret, f;
    ret = enfactorial();
    switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
      case POWER0 :
      ...
      switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
        ...
        case DIVIDE :
          ...
          if (x.kind == MULTIPLY)
            ...
            ret = new ExpressionNode(kernel, ret, ExpressionNode.VECTORPRODUCT,
                f);
          break;
        case NOT :
        case FACTORIAL :
  ...
  final public ExpressionValue enunary() throws ParseException {
    ...
    switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
      case MINUS :
        ...
        {
          if (true)
            return new ExpressionNode(kernel, new MyDouble(kernel, -1.0d),
                ExpressionNode.MULTIPLY, e);
        }
      case PLUS :
   ...
   */
  final private ExpressionNode expression() throws ParseException {
    ExpressionNode rhs;
    rhs = expressionnode();
   ...
   */
  final private ExpressionNode expressionnode() throws ParseException {
    ExpressionValue ret, f;
    ret = ANDterm();
    label_6 : while (true) {
      switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
  ...
  /**
   * function = label(x) = expressionnode note: may also include commands in
   * expressionnode
   */
  ...
  final private boolean jj_3R_101() {
    if (jj_scan_token(CONTAINS_STRICT))
      return true;
    if (jj_3R_86())
      return true;
    return false;
  ...
  final private boolean jj_3R_105() {
    if (jj_scan_token(GREATER_EQUAL))
      return true;
    if (jj_3R_86())
      return true;
    return false;
  ...
  final private boolean jj_3R_107() {
    if (jj_scan_token(PERPENDICULAR))
      return true;
    if (jj_3R_86())
      return true;
    return false;
  ...
  final private boolean jj_3R_109() {
    if (jj_scan_token(POWER0))
      return true;
    return false;
  }

  final private boolean jj_3R_110() {
    if (jj_scan_token(POWER1))
      return true;
    return false;
  }

  final private boolean jj_3R_111() {
    if (jj_scan_token(SQUARED))
      return true;
    return false;
  }

  final private boolean jj_3R_112() {
    if (jj_scan_token(CUBED))
      return true;
    return false;
  }

  final private boolean jj_3R_113() {
    if (jj_scan_token(POWER4))
      return true;
    return false;
  }

  final private boolean jj_3R_114() {
    if (jj_scan_token(POWER5))
      return true;
    return false;
  }

  final private boolean jj_3R_115() {
    if (jj_scan_token(POWER6))
      return true;
    return false;
  }

  final private boolean jj_3R_116() {
    if (jj_scan_token(POWER7))
      return true;
    return false;
  }

  final private boolean jj_3R_117() {
    if (jj_scan_token(POWER8))
      return true;
    return false;
  }

  final private boolean jj_3R_118() {
    if (jj_scan_token(POWER9))
      return true;
    return false;
  }
  ...
  final private boolean jj_3R_12() {
    if (jj_scan_token(FUNCTION_LABEL))
      return true;
    if (jj_scan_token(VARX))
      return true;
    if (jj_scan_token(96))
      return true;
    Token xsp;
  ...
  final private boolean jj_3R_13() {
    if (jj_scan_token(SPREADSHEET_LABEL))
      return true;
    if (jj_scan_token(90))
      return true;
    if (jj_scan_token(SPREADSHEET_LABEL))
  ...
  final private boolean jj_3R_21() {
    ...
    if (jj_3R_16())
      return true;
    if (jj_scan_token(CARTESIAN_SPECIAL_SEPERATOR))
      return true;
    if (jj_3R_16())
      return true;
    if (jj_scan_token(96))
  ...
  final private boolean jj_3R_39() {
    ...
    if (jj_3R_85())
      return true;
    if (jj_scan_token(EQUAL_BOOLEAN))
      return true;
    if (jj_3R_86())
      return true;
    Token xsp;
  ...
  final private boolean jj_3R_99() {
    if (jj_scan_token(IS_ELEMENT_OF))
      return true;
    if (jj_3R_86())
      return true;
    return false;
   ...
   */
  final public Vector<String> labellist() throws ParseException {
    Token t;
  ...
  final private ExpressionValue list() throws ParseException {
    MyList myList;
    ExpressionValue ev;
    if (jj_2_29(5)) {
      jj_consume_token(91);
  ...
  final public ExpressionValue myDouble() throws ParseException {
    ...
    switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
      ...
      case EFLOAT :
        ...
        if (MathPiperParsing) // preserve string from MathPiper: it may have
        // higher
      ...
      case PI :
        ...
        {
          if (true)
            return new MySpecialDouble(kernel, Math.PI, Kernel.PI_STRING);
        }
      case E :
        jj_consume_token(E);
        {
          if (true)
            return new MySpecialDouble(kernel, Math.E, Kernel.EULER_STRING);
        }
      case INFINITY :
  ...
  /**
   * NOTterm = <NOT> <enelement> | <enelement>
   */
  final private ExpressionValue NOTterm() throws ParseException {
    ExpressionValue en;
    switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
      case NOT :
      case FACTORIAL :
  ...
  final public ExpressionNode numberFunction() throws ParseException {
    ...
    switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
      ...
      case FUNCTION_LABEL :
        ...
        if (order > 0) { // derivative
          if (geo.isGeoFunction()) {// function
            ...
            ExpressionNode derivative = new ExpressionNode(kernel, geoExp,
                ExpressionNode.DERIVATIVE, new MyDouble(kernel, order));
            {
              if (true)
                return new ExpressionNode(kernel, derivative,
                    ExpressionNode.FUNCTION, en);
            }
          } else {
        ...
        } else if (geo.isGeoFunction()) // function
        {
          if (true)
            return new ExpressionNode(kernel, geoExp, ExpressionNode.FUNCTION,
                en);
        } else if (geo.isGeoCurveCartesian()) // vector function
        {
          if (true)
            return new ExpressionNode(kernel, geoExp,
                ExpressionNode.VEC_FUNCTION, en);
  ...
  final private ExpressionValue numVecVariable() throws ParseException {
    Token c;
    ExpressionValue ev;
    switch (jj_ntk == -1 ? jj_ntk() : jj_ntk) {
      case VARX :
  ...
  /**
   * parametric = <PARAMETRICVAR> = vector + <LABEL> * vector | <PARAMETRICVAR>
   * = vector - <LABEL> * vector |
   */
  final public Parametric parametric() throws ParseException {
    ...
    v = expression();
    if (s.kind == MINUS)
      v = new ExpressionNode(kernel, new MyDouble(kernel, -1.0d),
          ExpressionNode.MULTIPLY, v);
   ...
   */
  public Function parseFunction(String parseString) throws ParseException {
    myReInit(parseString);
    return function();
  }
   ...
   */
  public ValidExpression parseGeoGebraCAS(String parseString)
      throws ParseException {
    myReInit(parseString);
   ...
   * Parses a String and returns a ValidExpression Object
   */
  public ValidExpression parseGeoGebraExpression(String parseString)
      throws ParseException {
    myReInit(parseString);
   ...
   */
  public ValidExpression parseMathPiper(String parseString)
      throws ParseException {
    myReInit(parseString);
   ...
   * @throws ParseException
   */
  final private VectorValue polarvector() throws ParseException {
  ...
  final public Command spreadsheetRange() throws ParseException {
    ...
    ExpressionNode startCell = new ExpressionNode(kernel, new Variable(kernel,
        c.image));
    ExpressionNode endCell = new ExpressionNode(kernel, new Variable(kernel,
        c2.image));
    Command cmd = new Command(kernel, "CellRange", false); // don't translate
    // name
