...
public class ManagedProperties {
     ...
     */
    private static final HashMap<ClassLoader, HashMap<String, Value>> propertiesCache = new HashMap<ClassLoader, HashMap<String, Value>>();
    ...
    public static void setProperty(String propertyName, String value, boolean isDefault) {
        if (propertyName != null) {
            synchronized (propertiesCache) {
                ...
                HashMap<String, Value> properties = propertiesCache.get(classLoader);
    ...
    private static final Value getValueProperty(ClassLoader classLoader, String propertyName) {
        ...
        if (propertyName != null) {
            ...
            if (value == null  ||  value.isDefault) {
                synchronized (propertiesCache) {
                    HashMap properties = propertiesCache.get(classLoader);
